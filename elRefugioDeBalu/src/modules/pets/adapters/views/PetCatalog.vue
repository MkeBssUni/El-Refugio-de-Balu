                            ...
                            <b-form>
                                <b-row>
                                    ...
                                    <b-col cols="12" sm="6" class="mt-2">
                                        <b-form-select v-model="category" class="form-select">
                                    ...
                                    <b-col cols="12" sm="6" class="mt-3">
                                        <b-form-select v-model="lifeStage" class="form-select">
                                    ...
                                    <b-col cols="12" class="mt-3">
                                        <b-form-select v-model="state" class="form-select">                                            
    ...
    data() {
        return {
            ...
            pets: [
                ...
                { id: 2, name: 'Balu', category: 'perro', size: 'mediano', age: 'cachorro', sex: 'macho', state: 'Morelos', city: 'Cuernavaca', favorite: false, img: 'https://cdn.unotv.com/images/2023/11/01-perro-cachorrito-153446-1024x576.jpg' },
