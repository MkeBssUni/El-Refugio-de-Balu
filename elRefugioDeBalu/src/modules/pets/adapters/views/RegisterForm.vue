            ...
            <b-form>
                ...
                <b-col cols="12" class="px-5 my-5">
                    <b-card bg-variant="card-header-blue" class="w-50 py-2 card-shadow" no-body>
                        <div class="d-flex align-items-center ms-4">
                            <i class="material-icons me-2" style="font-size: 1.5rem">local_hospital</i>
                            ...
                            <b-row>
                                <b-col cols="12">
                                    <b-form-group>
                                            ...
                                            <b-col cols="6">
                                                <div class="mb-2 form-check">
                                                    <input id="isDewormed" type="checkbox" class="form-check-input"
                                                        v-model="form.isDewormed" value="true"
                                                        unchecked-value="false">
                                            ...
                                            <b-col cols="6">
                                                <div class="mb-2 form-check">
                                                    <input id="microchip" type="checkbox" class="form-check-input"
                                                        v-model="form.microchip" value="true"
                                                        unchecked-value="false">
                                        ...
                                        <b-row class="mt-3">
                                            <b-col cols="6">
                                                <b-form-group label="Escribe las enfermedades o padecimientos de la mascota (si aplica):" label-for="diseases">
                                                    <b-form-input id="diseases" v-model.trim="form.diseases"
                                                        placeholder="Enfermedad o padecimiento..."></b-form-input>
                                                </b-form-group>
                                            </b-col>
                                            <b-col cols="6">
                                                <b-form-group label="Escribe las alergias de la mascota (si aplica):" label-for="allergies">
                                                    <b-form-input id="allergies" v-model.trim="form.allergies"
                                                        placeholder="Alergia..."></b-form-input>
                                                </b-form-group>
                                            </b-col>
                                            <b-col cols="12" class="mt-3">
                                                <b-form-group label="Escribe comentarios adicionales sobre la salud de la mascota (si aplica):" label-for="comments">
