    ...
    <b-container>
        <b-row>
            <b-col cols="6" lg="5" xl="4">
                <b-row>
                    <b-col cols="12">
                        <b-img :src="pet.mainImage" class="pet-main-img"
            ...
            <b-col cols="6" lg="7" xl="8" class="ps-3 ps-lg-5">
                ...
                <b-row class="mt-3 g-0">
                    ...
                    <b-col cols="12" lg="6" class="d-flex">
                        ...
                        <p class="text-dark-gray-input pet-p">{{ mapSize((pet.size).toString().toLowerCase()) }}
                        </p>
                    </b-col>
                    <b-col cols="12" lg="6" class="d-flex">
                ...
                <b-row class="mt-3">
                    ...
                    <b-row>
                        ...
                        <b-col cols="12" lg="6">
                            <p class="mt-md-4 mt-lg-0 pet-p">Enfermedades:</p>
